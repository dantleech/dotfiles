...
globalkeys = awful.util.table.join(
    awful.key({ 	          }, "XF86TouchpadToggle",  function () os.execute('xrotate +') end),
    awful.key({}, "#122", function () volume.volume("down", tb_volume) end),
    awful.key({}, "#123", function () volume.volume("up", tb_volume) end),
    awful.key({}, "#121", function () volume.volume("mute", tb_volume) end),
    awful.key({ modkey         }, ".",  function () os.execute('xrotate +') end),
